        ...
        >
          <CardContent>
            ...
            >
                ...
                sx={{mb:5,mt:4,
                  background: 'linear-gradient(45deg, '&:hover': {
                    background: 'linear-gradient(45deg, #6FB3F6, #9D4EF8)', // Reverse gradient on hover
               , #6FB3F6)',
                  color: 'white',
                  '&:hover': {
                    background: 'linear-gradient(45deg, #6FB3F6, #9D4EF8)', }
               }}
              >
                Sign Up
              </Button>
